  ...
  return (
    <div id="home-view">
      <section className="hero" id="top">
        ...
        <div className="wrap">
          <span className="eyebrow">Private advisory , Mumbai & beyond</span>
          ...
          <div className="trust"><span>Advising since 2014</span><span>Buyer-side only</span><span>South Mumbai &amp; beyond</span></div>
        </div>
      </section>
      ...
      <section id="approach" data-anim="right">
        <div className="wrap">
          <div className="head"><span className="eyebrow">The Approach</span><h2>I represent <em>you</em>. That changes everything.</h2>
            <p className="appr-intro">Most brokers represent the developer and work around their commission. I represent you, the person buying the home.That single fact decides which residences you are shown, what I tell you about each one, and the price you finally pay.</p></div>
      ...
      <section id="book" data-anim="left">
        <div className="wrap"><div className="head"><span className="eyebrow">By Appointment</span><h2>Request a private <em>consultation</em>.</h2></div>
          <div className="book-grid">
            <div className="book"><p className="intro">Tell me what you are looking for, then choose a convenient time. Expect a curated, honest market appraisal tailored strictly to your goals.</p>
